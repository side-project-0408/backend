...
public class QPeopleResponseDto extends ConstructorExpression<PeopleResponseDto> {
    ...
    public QPeopleResponseDto(com.querydsl.core.types.Expression<String> nickname, com.querydsl.core.types.Expression<Integer> favoriteCount, com.querydsl.core.types.Expression<Integer> viewCount, com.querydsl.core.types.Expression<String> position, com.querydsl.core.types.Expression<String> userFileUrl, com.querydsl.core.types.Expression<String> techStack, com.querydsl.core.types.Expression<String> softSkill, com.querydsl.core.types.Expression<Long> userId) {
        super(PeopleResponseDto.class, new Class<?>[]{String.class, int.class, int.class, String.class, String.class, String.class, String.class, long.class}, nickname, favoriteCount, viewCount, position, userFileUrl, techStack, softSkill, userId);
    }
